...
import {
  ...
  MainText,
  SubText,
  MuscleTextSelectedContainer,
  MuscleText,
  MainImgContainer,
  BodySvg,
} from "./styles";
// data //
import { muscleData } from "@/public/data";
// Layout //
import BoxLayout from "./utilities/BoxLayout";

const Main = () => {
  // Set muscle selected //
  const [muscle, setMuscle] = useState<string>();
  // Set selected and filtered data of muscle //
  const [selectedMuscle, setSelectedMuscle] = useState<any>();
  // Handle response //
  const handleClick = (e: any) => {
    // Check id clicked //
    const clickedId = parseInt(e.target.id);
    // Filter out the matched muscles id //
    const matchingMuscle = muscleData.find((muscle) => muscle.id === clickedId);
    if (matchingMuscle) {
      setMuscle(matchingMuscle.name);
      setSelectedMuscle(matchingMuscle);
    } else {
      console.log("No matching muscle found");
    }
  };
        ...
        {muscle === undefined || "" || null ? (
          <TextContainerBox>
            <TextContainer>
              ...
              <MainText>Workout</MainText>
              <SubText>Choose Muscle Category</SubText>
            </TextContainer>
          </TextContainerBox>
        ) : (
          <MuscleTextSelectedContainer>
            <MuscleText>{muscle}</MuscleText>
            <BoxLayout data={selectedMuscle.variations} />
          </MuscleTextSelectedContainer>
        )}
      </MainTextContainer>
      <MainImgContainer>
